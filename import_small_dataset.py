...
original_dataset_dir = '/home/ogai/Downloads/dogs-vs-cats/train'
...
fnames = ['cat.{}.jpg'.format(i) for i in range(9000, 11250)]
for fname in fnames:
    src = os.path.join(original_dataset_dir, fname)
...
fnames = ['dog.{}.jpg'.format(i) for i in range(9000, 11250)]
for fname in fnames:
    src = os.path.join(original_dataset_dir, fname)
